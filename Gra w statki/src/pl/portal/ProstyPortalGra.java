...
public class ProstyPortalGra {
	...
	public static void main(String[] args) {		
		...
		ProstyPortal portal = new ProstyPortal(); // tworzymy nowy obiekt w ProstyPortal	
		...
		portal.setPolaPolozenia(polozenie);     // przekazujemy do obiektu ProstyPortal jego polozenie 	(w formie tablicy)
