import analyze    # importuje modul analyze i na jego podstawie oblicza czytelnosc nowego tekstu ponizej

analyze.oblicz_czytelnosc('''If you've never programmed a computer, you should. There's nothing like it in the
